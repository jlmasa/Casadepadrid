...
<div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <a href="index.html" class="navbar-brand hidden-lg">CASA PADRID</a>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="combo_save.php">
                  ...
                  <!-- Title -->
				 <div class="form-group">
                      <label class="control-label col-lg-3" for="username">Type</label>
                      <div class="col-lg-8"> 
                        <select class="form-control select2 " id="exampleSelect1" name="combo_type" placeholder="Select type" required>
